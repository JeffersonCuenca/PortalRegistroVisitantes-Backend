...
public class PortalRegistroVisitantesApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(PortalRegistroVisitantesApplication.class, args);
	}
